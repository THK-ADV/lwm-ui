...
@NgModule({
    ...
    entryComponents: [DeleteDialogComponent, CreateUpdateDialogComponent, UserAuthorityUpdateDialogComponent, GroupEditComponent, CourseDetailComponent, CourseAuthorityUpdateDialogComponent]
})
