...
export const explicitEvaluationKind = (
  evals: Readonly<ReportCardEvaluationAtom[]>,
): ExplicitEvaluationKind | undefined => {
...
export type ReportCardEvaluationPatternProtocol = Omit<
