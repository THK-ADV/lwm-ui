...
export const format = (date: Date, pattern: DateTimePattern | TimePattern): string => {
    registerLocaleData(localDE, 'de')
    return formatDate(date, pattern, 'de')
}

export const formatTime = (time: Time, pattern: TimePattern = 'HH:mm:ss'): string =>
    format(time.date, pattern)
