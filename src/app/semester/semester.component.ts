...
export class SemesterComponent {
  ...
  static startEndValidator = (data: FormInput[]): ValidatorFn | undefined => {
    ...
    return (group: FormGroup) => {
      ...
      const error = {}
      error[start.formControlName] =
        `${start.displayTitle} muss vor dem ${end.displayTitle} liegen`
      ...
      makeInput: (attr, e) => {
        switch (attr) {
          ...
          case "abbreviation":
            return {
              isDisabled: false,
              data: new FormInputString(e.abbreviation),
            }
          case "start":
            return {
              isDisabled: isUniqueEntity(e),
              data: new FormInputDate(e.start),
            }
          case "end":
            return {
              isDisabled: isUniqueEntity(e),
              data: new FormInputDate(e.end),
            }
          case "examStart":
            return {
              isDisabled: isUniqueEntity(e),
              data: new FormInputDate(e.examStart),
            }
        }
      },
      commitProtocol: (p, s) => {
