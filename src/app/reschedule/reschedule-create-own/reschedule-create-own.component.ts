...
export class RescheduleCreateOwnComponent implements OnInit {
    ...
    static createTimeFormControl = () => new FormControl(
        undefined,
        [
    ...
    ngOnInit(): void {
        ...
        resetControls([this.startTimeControl, this.endTimeControl, this.roomControl])
    }
    ...
    resetControls = () => resetControls([this.startTimeControl, this.endTimeControl, this.roomControl])
}
