...
//
//     constructor(
//         readonly labworkApplicationService: LabworkApplicationService,
//         readonly dialog: MatDialog,
//         readonly alertService: AlertService,
//         readonly userService: UserService,
//         readonly route: ActivatedRoute,
//         readonly labworkService: LabworkService
//     ) {
//         super(
//             () => labworkApplicationService,
//             dialog,
//             alertService,
...
//             }),
//             switchMap(l => this.labworkApplicationService.getAllByLabworkAtom(l.id))
//         )
//
//         this.fetchData(apps$)
//     }
