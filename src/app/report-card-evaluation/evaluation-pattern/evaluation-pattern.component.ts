...
export class EvaluationPatternComponent implements OnInit {
  ...
  constructor(private readonly service: ReportCardEvaluationPatternService) {
    this.columns = [
        ...
        switch (attr) {
          case "entryType":
            return {
              ...
              data: uniqueEntity
                ? new FormInputString(e.entryType)
                : new FormInputSelect(e.entryType, allEntryTypes()),
            }
          case "property":
            return {
              isDisabled: uniqueEntity,
              data: uniqueEntity
                ? new FormInputString(e.property)
                : new FormInputSelect(e.property, allPropertyTypes()),
            }
          case "min":
