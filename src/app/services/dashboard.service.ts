...
export class DashboardService {
  ...
  getStudentDashboard = (
    ...filter: DashboardHttpFilter[]
  ): Observable<StudentDashboard> =>
    this.http
      .get_<StudentDashboardJSON>(this.path, applyFilter(filter, atomicParams))
  ...
  getEmployeeDashboard = (
    ...
    this.http
      .get_<EmployeeDashboardJSON>(this.path, applyFilter(filter, atomicParams))
      .pipe(map(this.employeeDashboardFromJSON))

  private employeeDashboardFromJSON = (
    x: EmployeeDashboardJSON,
  ): EmployeeDashboard => ({
    ...x,
  ...
  private studentDashboardFromJSON = (
    x: StudentDashboardJSON,
  ): StudentDashboard => ({
    ...x,
    semester: mapSemesterJSON(x.semester),
