...
const makeScheduleEntryEvent = (
  rooms: string[],
): ((e: ScheduleEntryGen) => ScheduleEntryEvent<ScheduleEntryProps>) => {
  return (e) => {
...
export const createSchedule = (
  ...
  if (isEmpty(entries)) {
    ...
    return service.create(courseId, {
      labwork: labworkId,
      entries: scheduleEntryGenProtocol(entries),
    })
  }
}
