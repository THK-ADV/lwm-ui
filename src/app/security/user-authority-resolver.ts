...
export const userAuths = (route: ActivatedRoute): AuthorityAtom[] =>
  route.snapshot.data.userAuths

export const hasCourseManagerPermission = (
...
export class UserAuthorityResolver {
  ...
  resolve(): Observable<AuthorityAtom[]> {
    return fetchCurrentUserAuthorities$(
