...
export const syncAction = (): LWMAction => {
  return {
    ...
    color: "primary",
    iconName: "sync",
    tooltipName: "Mit LDAP abgleichen",
    tooltipPosition: "above",
  }
}
...
export const evaluateAction = (): LWMAction => {
  return {
    ...
    color: "primary",
    iconName: "school",
    tooltipName: "Notenhefte evaluieren",
    tooltipPosition: "above",
  }
}
